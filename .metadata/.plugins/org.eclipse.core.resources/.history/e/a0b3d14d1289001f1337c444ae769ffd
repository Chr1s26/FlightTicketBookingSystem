...
public class Route {
	...
	public Route(int routeId,Airport depature, Airport arrival,int distance,Flight flight) {
	...
	public Route(Airport depature, Airport arrival,int distance,Flight flight) {
		this.depatureAirport = depature;
		this.arrivalAirport = arrival;
		this.distance = distance;
		this.flight = flight;
